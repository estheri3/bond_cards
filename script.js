const questions = {
  connect: [
    {
      ...
      verse: "나는 확신하노니 사망이나 생명이나 ... 우리를 우리 주 그리스도 예수 안에 있는 하나님의 사랑에서 끊을 수 없으리라 (로마서 8:38-39)",
      tags: ["#하나님", "#매듭", "#연결"]
    },
    {
      q: "나를 지탱해주는 “세겹줄 같은 관계”는 누구인가요?",
      verse: "세 겹 줄은 쉽게 끊어지지 아니하느니라 (전도서 4:12)",
      tags: ["#관계", "#세겹줄", "#연결"]
    },
    {
    ...
    {
      q: "캠퍼스 생활에서 지금 나를 가장 붙잡아 주는 끈(사람, 신앙, 취미 등)은 무엇인가요?",
      verse: "하나님은 미쁘사 너희를 굳게 세우시고 (데살로니가후서 3:3)",
      tags: ["#신앙", "#캠퍼스", "#연결"]
    },
    {
      q: "공동체 안에서 내가 맡고 싶은 ‘매듭 역할’은 무엇인가요?",
  ...
  bind: [
    {
      ...
      verse: "너희는 가까이 하라 그리하면 너희를 가까이 하시리라 (야고보서 4:8)",
      tags: ["#하나님", "#거리", "#결박"]
    },
    {
    ...
    },
    {
      ...
      verse: "항상 기뻐하라, 쉬지 말고 기도하라, 범사에 감사하라 (데살로니가전서 5:16-18)",
      tags: ["#습관", "#결박"]
    },
    {
    ...
    {
      q: "때로는 매듭을 억지로 풀기보다 그냥 묶어두는 것이 지혜일 때도 있는데, 내 삶에서 그런 매듭은 무엇일까요?",
      verse: "천하 만사가 다 때가 있나니 (전도서 3:1)",
      tags: ["#지혜", "#때", "#결박"]
    }
  ],
  ...
  free: [
    ...
    {
      q: "지금 내 삶에서 풀고 싶은 '매듭' 같은 고민이나 과제가 있다면 무엇인가요?",
      verse: "수고하고 무거운 짐 진 자들아 다 내게로 오라 내가 너희를 쉬게 하리라 (마태복음 11:28)",
      tags: ["#고민", "#자유"]
    },
    {
      q: "반대로, 소중해서 꼭 묶어 두고 싶은 '매듭' 같은 관계나 기억은 무엇인가요?",
      verse: "사랑은 많은 물이 꺼치지 못하겠고 홍수라도 엄몰하지 못하나니 (아가 8:7)",
      tags: ["#관계", "#기억", "#자유"]
    },
    {
