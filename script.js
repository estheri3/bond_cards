...
const questions = {
  connect: [
    {
      ...
      verse: "나는 확신합니다. 사망이나 생명이나 천사들이나 권세자들이나 ... 우리를 우리 주 그리스도 예수 안에 있는 하나님의 사랑에서 끊을 수 없으리라 (로마서 8:38-39)",
      tags: ["#하나님", "#매듭", "#연결"]
    },
    {
  ...
  bind: [
    ...
    {
      q: "죄의 습관이 매듭처럼 나를 묶었던 경험은?",
      verse: "너희가 본래 죄의 종이더니 ... 이제는 의에게 종이 되어 거룩함에 이르렀다 (로마서 6:17-18)",
      tags: ["#죄", "#속박"]
    }
  ],
  free: [
    ...
    {
      q: "용서를 통해 풀린 매듭 같은 경험은?",
      verse: "서로 용납하여 피차 용서하되 ... 주께서 너희를 용서하신 것 같이 너희도 그리하라 (골로새서 3:13)",
      tags: ["#용서", "#자유"]
    }
  ]
};
